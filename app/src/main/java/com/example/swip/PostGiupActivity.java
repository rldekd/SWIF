            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (hotelLocation.equals(null)) {
                        Toast.makeText(PostGiupActivity.this, "Location is null", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        if (hotelName.equals(null)) {
                            Toast.makeText(PostGiupActivity.this, "Hotel Name is Null", Toast.LENGTH_SHORT).show();
                        } else {
