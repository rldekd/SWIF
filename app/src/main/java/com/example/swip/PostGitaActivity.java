...
public class PostGitaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!s.toString().isEmpty()) {
                    ...
                    mAdapter = new RecyclerAdapter(PostGitaActivity.this, mPostModel);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("기타");
        ...
        if (isNetworkConnected()) {
            mDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(PostGitaActivity.this, "Permission Denied...", Toast.LENGTH_SHORT).show();
                    Toast.makeText(PostGitaActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    circleP_bar.setVisibility(View.INVISIBLE);
                }
            });
        } else {
        ...
        extended_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), AddPostActivity_gita.class));
                return;
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (hotelLocation.equals(null)) {
                        Toast.makeText(PostGitaActivity.this, "Location is null", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        if (hotelName.equals(null)) {
                            Toast.makeText(PostGitaActivity.this, "Hotel Name is Null", Toast.LENGTH_SHORT).show();
                        } else {
                ...
                if (!filteredmPostModel.isEmpty()) {
                    ...
                    mAdapter = new RecyclerAdapter(PostGitaActivity.this, filteredmPostModel);
                    recyclerView.setAdapter(mAdapter);
                } else {
                    defaultView.setVisibility(View.VISIBLE);
                }
