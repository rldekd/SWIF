            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (postTitle.equals(null)) {
                        Toast.makeText(PostGitaActivity.this, "Title is null", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        if (postContent.equals(null)) {
                            Toast.makeText(PostGitaActivity.this, "Content is null", Toast.LENGTH_SHORT).show();
                        } else {
