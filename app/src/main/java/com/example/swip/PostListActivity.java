...
public class PostListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!s.toString().isEmpty()) {
                    ...
                    mAdapter = new RecyclerAdapter(PostListActivity.this, mPostModel);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("초딩");
        ...
        if (isNetworkConnected()) {
            mDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(PostListActivity.this, "Permission Denied...", Toast.LENGTH_SHORT).show();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (hotelLocation.equals(null)) {
                        Toast.makeText(PostListActivity.this, "Location is null", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        if (hotelName.equals(null)) {
                            Toast.makeText(PostListActivity.this, "Hotel Name is Null", Toast.LENGTH_SHORT).show();
                        } else {
                ...
                if (!filteredmPostModel.isEmpty()) {
                    ...
                    mAdapter = new RecyclerAdapter(PostListActivity.this, filteredmPostModel);
                    recyclerView.setAdapter(mAdapter);
                } else {
                    defaultView.setVisibility(View.VISIBLE);
                }
