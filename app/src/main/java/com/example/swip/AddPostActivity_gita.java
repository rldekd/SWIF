...
public class AddPostActivity_gita extends AppCompatActivity {
    ...
    String mTitle, mContent, mhotelRating,mhotelPricePerHour,email,phone,mapUrl,webUrl, mhotelTagList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("기타"); // 얘가 이름인 것 같음
        databaseReference = FirebaseDatabase.getInstance().getReference("기타");
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    if (ContextCompat.checkSelfPermission(getApplicationContext(),
                        ...
                        ActivityCompat.requestPermissions(AddPostActivity_gita.this,
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), PostChoStuActivity.class));
                finish();
        ...
        if (image_uri != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddPostActivity_gita.this, "글이 등록되지 않았습니다.", Toast.LENGTH_SHORT).show();
                }
            }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(AddPostActivity_gita.this, "글이 등록되었습니다.", Toast.LENGTH_LONG).show();
                    ...
                    if (taskSnapshot.getMetadata() != null)
                        if (taskSnapshot.getMetadata().getReference() != null) {
                            ...
                            result.addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    mProgress.setVisibility(View.INVISIBLE);
                                    Toast.makeText(AddPostActivity_gita.this, "Database Fail...", Toast.LENGTH_SHORT).show();
                                }
                            });
        ...
        if (etTitle.getText().toString().isEmpty()) {
            ...
            if (mUploadTask != null && mUploadTask.isInProgress()) {
                ...
                if (isNetworkConnected()) {
                    ...
                    Toast.makeText(AddPostActivity_gita.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                }
