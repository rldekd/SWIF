...
public class AddPostActivity_go extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("고등학생"); // 얘가 이름인 것 같음
        databaseReference = FirebaseDatabase.getInstance().getReference("고등학생");
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    if (ContextCompat.checkSelfPermission(getApplicationContext(),
                        ...
                        ActivityCompat.requestPermissions(AddPostActivity_go.this,
        ...
        if (image_uri != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddPostActivity_go.this, "글이 등록되지 않았습니다.", Toast.LENGTH_SHORT).show();
                }
            }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(AddPostActivity_go.this, "글이 등록되었습니다.", Toast.LENGTH_LONG).show();
                    ...
                    if (taskSnapshot.getMetadata() != null)
                        if (taskSnapshot.getMetadata().getReference() != null) {
                            ...
                            result.addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    mProgress.setVisibility(View.INVISIBLE);
                                    Toast.makeText(AddPostActivity_go.this, "Database Fail...", Toast.LENGTH_SHORT).show();
                                }
                            });
        ...
        if (etTitle.getText().toString().isEmpty()) {
            ...
            if (mUploadTask != null && mUploadTask.isInProgress()) {
                ...
                if (isNetworkConnected()) {
                    ...
                    Toast.makeText(AddPostActivity_go.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                }
